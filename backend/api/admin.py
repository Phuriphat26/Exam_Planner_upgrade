...
@admin_required # ตรวจสอบสิทธิ์ Admin ก
def get_summary():
    """
    ...
    try:
        ...
        pipeline = [
            ...
            },
            {
                '$unwind': { 
                    'path': '$admin_info',
                    'preserveNullAndEmptyArrays': True # เก็บ Log 
                } 
            },
            {
                '$project': { 
...
@admin_required # ตรวจสอบสิทธิ์ Admin 
def create_summary():
    """
